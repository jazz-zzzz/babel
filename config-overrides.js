...
// @description   A simple bilingual translation extension & Greasemonkey script (一个Babel的双语对照翻译扩展 & 油猴脚本)
...
`;
  ...
  config.entry = {
    ...
    "babel.user": paths.appSrc + "/userscript.js",
  };
