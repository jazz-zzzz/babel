...
export const MSG_FETCH = "babel_fetch"; // 代理请求 (避免内容脚本跨域限制)
...
export const PORT_STREAM_FETCH = "babel_stream_fetch"; // 双向长连接端口名称：用于大模型翻译时的流式输出通道
export const MSG_UPDATE_ICON = "update_icon"; // 通知后台脚本更新扩展的工具栏图标状态 (激活/灰色状态)

// --- 用于 Window.postMessage 与自定义事件通信的事件名称 ---
export const EVENT_BABEL_INNER = "babel_inner"; // 插件沙箱/内容脚本内部事件
export const EVENT_BABEL_TRANSLATOR = "babel"; // 暴露给网页环境的外部交互事件

// --- 视频与字幕翻译特定消息类型 ---
export const MSG_XHR_DATA_BABEL = "BABEL_XHR_DATA_YOUTUBE"; // 传递 YouTube 拦截到的字幕 XHR 数据
