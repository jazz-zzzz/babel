...
// --- 配置同步设置 ---
export const OPT_SYNCTYPE_WORKER = "Babel-Worker"; // 自建 Cloudflare Worker 同步方案
...
export const DEFAULT_SUBTITLE_SETTING = {
  ...
  pauseOnSubtitleHover: false, // 鼠标悬停字幕区域时是否自动暂停视频
  ...
  contextVideoSummary: false, // AI 视频内容摘要（额外 API 调用）
};
