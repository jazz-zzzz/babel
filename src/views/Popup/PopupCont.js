...
export default function PopupCont({
  ...
  const handleMousehoverToggle = async (e) => {
    try {
      ...
      babelLog("toggle mousehover", err);
    }
  };
  ...
  const handleInputTransToggle = async (e) => {
    try {
      ...
      babelLog("toggle inputtrans", err);
    }
  };
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        babelLog("get domain options", err);
      }
    })();
  }, [isContent]);
      ...
      <Stack>
        ...
        >
          ...
          <Button
            ...
            onClick={() => {
              window.open(
                "https://github.com/jazz-zzzz/babel#%E8%B5%9E%E8%B5%8F",
                "_blank"
              );
            }}
          >
