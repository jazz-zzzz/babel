    ...
    if (!rules) {
      ...
      (async () => {
        try {
          ...
          babelLog("getDisabledSubRules", err);
        }
      })();
    }
            ...
            <Switch
              ...
              onChange={async (e) => {
                ...
                try {
                  ...
                  babelLog("toggle disabled sub rule", err);
    ...
    <Stack spacing={3}>
      ...
      >
        ...
        <DownloadButton
          ...
          text={i18n("export")}
          fileName={`babel-rules_v2_${Date.now()}.json`}
        />
        ...
        <HelpButton url={URL_BABEL_RULES_NEW_ISSUE} />
  ...
  const handleDel = async () => {
    try {
      ...
      try {
        ...
        babelLog("removeDisabledSubRules", err);
      }
    } catch (err) {
      babelLog("del subrules", err);
    }
  };
