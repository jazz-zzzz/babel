  ...
  const handleTranslation = async () => {
    ...
    for (const word of wordList) {
      try {
        ...
        babelLog("export translation", err);
      }
    }
      ...
      <Stack spacing={3}>
        ...
        >
          ...
          <DownloadButton
            ...
            text={i18n("export")}
            fileName={`babel-words_${Date.now()}.txt`}
          />
          ...
          <DownloadButton
            ...
            fileName={`babel-words_${Date.now()}.csv`}
          />
          ...
          <DownloadButton
            ...
            text={i18n("export") + " (MD)"}
            fileName={`babel-words_${Date.now()}.md`}
          />
