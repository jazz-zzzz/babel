      ...
      <Stack spacing={3}>
        ...
        <Box>
          <Grid container spacing={2} columns={12}>
            ...
            {/* 鼠标悬停在字幕区域时是否自动暂停视频播放 */}
            <Grid item xs={12} sm={12} md={6} lg={3}>
              <TextField
                fullWidth
                select
                size="small"
                name="pauseOnSubtitleHover"
                value={pauseOnSubtitleHover}
                label={i18n("pause_on_subtitle_hover")}
                onChange={handleChange}
              >
                <MenuItem value={true}>{i18n("enable")}</MenuItem>
                <MenuItem value={false}>{i18n("disable")}</MenuItem>
            ...
            {/* 是否在字幕翻译前先调用 AI 生成视频内容摘要 */}
            <Grid item xs={12} sm={12} md={6} lg={3}>
              <TextField
                fullWidth
                select
                size="small"
                name="contextVideoSummary"
                value={contextVideoSummary}
                label={i18n("context_video_summary")}
                onChange={handleChange}
              >
                <MenuItem value={true}>{i18n("enable")}</MenuItem>
                <MenuItem value={false}>{i18n("disable")}</MenuItem>
