                ...
                <FormControlLabel
                  control={
                    <Switch
                      size="small"
                      name="contextDocInfo"
                      checked={contextDocInfo}
                      onChange={handleChange}
                    />
                  }
                  label={i18n("context_doc_info")}
                />
              </Grid>
              <Grid item xs={12} sm={12} md={6} lg={3}>
                <FormControlLabel
                  control={
                    <Switch
                      size="small"
                      name="contextChatHistory"
                      checked={contextChatHistory}
                      onChange={handleChange}
                    />
                  }
                  label={
                    <Typography variant="body2">
                      {i18n("context_chat_history")}
                    </Typography>
                  }
                />
                <Typography
                ...
                >
                  {i18n("context_chat_history_hint")}
                </Typography>
              </Grid>
              {contextChatHistory && (
                <Grid item xs={12} sm={12} md={6} lg={3}>
    ...
    <Box>
      <Stack spacing={3}>
        <Alert severity="info">
          ...
          {i18n("about_api_3")}
          <Link
            href="https://github.com/jazz-zzzz/babel/blob/master/custom-api_v2.md"
            target="_blank"
          >
