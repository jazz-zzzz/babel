 ...
 * @returns {string}
 */
export const genEventName = () => `babel-${btoa(Math.random()).slice(3, 11)}`;
 ...
 */
export function downloadBlobFile(str, filename = "babel-file.txt") {
  ...
  a.href = url;
  a.download = filename || `babel-file.txt`;
