...
export default class TranslatorManager {
  ...
  #setupMessageListeners() {
    ...
    // 监听其它前台扩展模块或外部页面事件直接派发的 EVENT_BABEL_TRANSLATOR CustomEvent 调用
    window.addEventListener(EVENT_BABEL_TRANSLATOR, this.#windowMessageHandler);
  }
    ...
    switch (action) {
      ...
      case MSG_OPEN_TRANBOX:
        document.dispatchEvent(
          new CustomEvent(EVENT_BABEL_INNER, {
